classdef RegularlySpacedIndexComposeTest < matlab.unittest.TestCase
  
  methods (Test)
    
    function testComposeWithAllIndex(testCase)
      index = matlabcoder.RegularlySpacedIndex(10, 20, 2);
    ...
    function testComposeWithUnitSpacedIndex1(testCase)
      index = matlabcoder.RegularlySpacedIndex(11, 20, 2);
    ...
    function testComposeWithRegularlySpacedIndex1(testCase)
      index = matlabcoder.RegularlySpacedIndex(11, 20, 3);
      subIndex = matlabcoder.RegularlySpacedIndex(5, 7, 2);
      composedIndex = index.compose(subIndex);
      
      testCase.assertEqual(composedIndex, matlabcoder.RegularlySpacedIndex(15, 17, 6));
    end
    ...
    function testComposeWithRegularlySpacedIndex2(testCase)
      ...
      testCase.assertEqual(composedIndex, matlabcoder.RegularlySpacedIndex(15, 20, 6));
    end
