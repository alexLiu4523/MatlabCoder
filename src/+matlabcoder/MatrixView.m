classdef MatrixView < matlabcoder.ViewBase
  ...
  methods
      ...
      if matlabcoder.OperationValue.isOperationValue(other)
        switch(other.operation)
          case matlabcoder.MatrixOperationEnum.PlusScalar
            if matlabcoder.MatrixView.isMatrixView(other.operandB) && matlabcoder.Util.isNumericScalar(other.operandA)
          ...
          case matlabcoder.MatrixOperationEnum.CPlusMatrix
            if matlabcoder.MatrixView.isMatrixView(other.operandA) && matlabcoder.MatrixView.isMatrixView(other.operandB)
              % this(view) = other.operandA(view) + other.operandB(view)
              visplstub.Stub_Vsip_CMAdd(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end
          ...
          case matlabcoder.MatrixOperationEnum.MinusCMatrix
            if matlabcoder.MatrixView.isMatrixView(other.operandA) && matlabcoder.MatrixView.isMatrixView(other.operandB)
              % this(view) = other.operandA(view) - other.operandB(view)
              visplstub.Stub_Vsip_RCMSub(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end

          case matlabcoder.MatrixOperationEnum.CMinusRMatrix
            if matlabcoder.MatrixView.isMatrixView(other.operandA) && matlabcoder.MatrixView.isMatrixView(other.operandB)
              % this(view) = other.operandA(view) - other.operandB(view)
              visplstub.Stub_Vsip_CRMSub(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end

          case matlabcoder.MatrixOperationEnum.CMinusMatrix
            if matlabcoder.MatrixView.isMatrixView(other.operandA) && matlabcoder.MatrixView.isMatrixView(other.operandB)
              % this(view) = other.operandA(view) - other.operandB(view)
              visplstub.Stub_Vsip_CMSub(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end

          case matlabcoder.MatrixOperationEnum.ScalarMinusMatrix
            if matlabcoder.MatrixView.isMatrixView(other.operandB) && matlabcoder.Util.isNumericScalar(other.operandA)
              % this(view) = other.operandA(scalar) - other.operandB(view) =>
          ...
          case matlabcoder.MatrixOperationEnum.ScalarMinusCMatrix
            if matlabcoder.MatrixView.isMatrixView(other.operandB) && matlabcoder.Util.isNumericScalar(other.operandA)
              % this(view) = other.operandA(scalar) - other.operandB(view) =>
              visplstub.Stub_Vsip_RSCMSub(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end

          case matlabcoder.MatrixOperationEnum.CScalarMinusMatrix
            if matlabcoder.MatrixView.isMatrixView(other.operandB) && matlabcoder.Util.isNumericScalar(other.operandA)
              % this(view) = other.operandA(scalar) - other.operandB(view) =>
              visplstub.Stub_Vsip_CSMSub(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end
          ...
          case matlabcoder.MatrixOperationEnum.LeftDivideScalar
            if matlabcoder.MatrixView.isMatrixView(other.operandA) && matlabcoder.Util.isNumericScalar(other.operandB)
              visplstub.Stub_Vsip_SMRDiv(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end
          ...
          case matlabcoder.MatrixOperationEnum.MatrixMTimesMatrix
            if matlabcoder.MatrixView.isMatrixView(other.operandA) && matlabcoder.MatrixView.isMatrixView(other.operandB)
              % this(view) = other.operandA(view) * other.operandB(view)
          ...
          case matlabcoder.MatrixOperationEnum.CMatrixMTimesMatrix
            if matlabcoder.MatrixView.isMatrixView(other.operandA) && matlabcoder.MatrixView.isMatrixView(other.operandB)
              % this(view) = other.operandA(view) * other.operandB(view)
              visplstub.Stub_Vsip_CMProd(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end

          case matlabcoder.MatrixOperationEnum.MatrixMTimesVector
          ...
          case matlabcoder.MatrixOperationEnum.LessThanScalar
            if matlabcoder.MatrixView.isMatrixView(other.operandB) && matlabcoder.Util.isNumericScalar(other.operandA)
              visplstub.Stub_Vsip_SMLt(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end
          ...
          case matlabcoder.MatrixOperationEnum.GreaterThanScalar
            if matlabcoder.MatrixView.isMatrixView(other.operandB) && matlabcoder.Util.isNumericScalar(other.operandA)
              visplstub.Stub_Vsip_SMGt(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end
          ...
          case matlabcoder.MatrixOperationEnum.LessEqualScalar
            if matlabcoder.MatrixView.isMatrixView(other.operandB) && matlabcoder.Util.isNumericScalar(other.operandA)
              visplstub.Stub_Vsip_SMLe(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end
          ...
          case matlabcoder.MatrixOperationEnum.GreaterEqualScalar
            if matlabcoder.MatrixView.isMatrixView(other.operandB) && matlabcoder.Util.isNumericScalar(other.operandA)
              visplstub.Stub_Vsip_SMGe(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end
          ...
          case matlabcoder.MatrixOperationEnum.NotEqualScalar
            if matlabcoder.MatrixView.isMatrixView(other.operandB) && matlabcoder.Util.isNumericScalar(other.operandA)
              visplstub.Stub_Vsip_SMNe(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end
          ...
          case matlabcoder.MatrixOperationEnum.CEqualToMatrix
            if matlabcoder.MatrixView.isMatrixView(other.operandA) && matlabcoder.MatrixView.isMatrixView(other.operandB)
              % this(view) = other.operandA(view) == other.operandB(view)
              visplstub.Stub_Vsip_CMEq(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end
          ...
          case matlabcoder.MatrixOperationEnum.EqualToScalar
            if matlabcoder.MatrixView.isMatrixView(other.operandB) && matlabcoder.Util.isNumericScalar(other.operandA)
              visplstub.Stub_Vsip_SMEq(other.operandA, other.operandB, this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end
          ...
          case matlabcoder.MatrixOperationEnum.CCTranspose
            if matlabcoder.MatrixView.isMatrixView(other.operandA)
              % this(view) = -other.operandA(view)
              visplstub.Stub_Vsip_CMTrans(other.operandA,this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end
          ...
          case matlabcoder.MatrixOperationEnum.Euler
            if matlabcoder.MatrixView.isMatrixView(other.operandA)
              % this(view) = exp(j*other.operandA(view))
              visplstub.Stub_Vsip_MEuler(other.operandA,this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end

          case matlabcoder.MatrixOperationEnum.ConjMul
            if matlabcoder.MatrixView.isMatrixView(other.operandA)&&matlabcoder.MatrixView.isMatrixView(other.operandB)
              % this(view) = other.operandA(view).*conj(other.operandB)
              visplstub.Stub_Vsip_CMJMul(other.operandA,this);
            else
              matlabcoder.Util.throwException('MatrixView:assignImpl:IllegalArgument', 'Illegal argument.');
            end
    ...
    function res = plus(this, B)
      coder.inline('never');
      if matlabcoder.MatrixView.isRealMatrix(B)&&matlabcoder.Util.isRealScalar(this)
        res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.PlusScalar, B);
      elseif matlabcoder.MatrixView.isRealMatrix(this)&&matlabcoder.MatrixView.isRealMatrix(B)
        res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.PlusMatrix, B);
      elseif matlabcoder.MatrixView.isComplexMatrix(this)&&matlabcoder.MatrixView.isComplexMatrix(B)
        res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.CPlusMatrix, B);
      else
    ...
    function res = minus(this, B)
      coder.inline('never');
      if matlabcoder.MatrixView.isRealMatrix(this)&&matlabcoder.MatrixView.isRealMatrix(B)
        res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.MinusMatrix, B);

      elseif matlabcoder.MatrixView.isRealMatrix(this)&&matlabcoder.MatrixView.isComplexMatrix(B)
        res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.MinusCMatrix, B);

      elseif matlabcoder.MatrixView.isComplexMatrix(this)&&matlabcoder.MatrixView.isRealMatrix(B)
        res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.CMinusRMatrix, B);

      elseif matlabcoder.MatrixView.isComplexMatrix(this)&&matlabcoder.MatrixView.isComplexMatrix(B)
        res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.CMinusMatrix, B);

      elseif matlabcoder.Util.isRealScalar(this)&&matlabcoder.MatrixView.isRealMatrix(B)
         res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.ScalarMinusMatrix, B);

      elseif matlabcoder.Util.isRealScalar(this)&&matlabcoder.MatrixView.isComplexMatrix(B)
         res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.ScalarMinusMatrix, B);

      elseif matlabcoder.Util.isComplexScalar(this)&&matlabcoder.MatrixView.isComplexMatrix(B)
         res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.ScalarMinusMatrix, B);
    ...
    function res = rdivide(this, B)
      coder.inline('never');
      if matlabcoder.MatrixView.isRealMatrix(this)&&matlabcoder.Util.isRealScalar(B)
    ...
    function res = ldivide(this, B)
      coder.inline('never');
      if matlabcoder.MatrixView.isRealMatrix(this)&&matlabcoder.Util.isRealScalar(B)
        res = matlabcoder.OperationValue.of(B, matlabcoder.MatrixOperationEnum.LeftDivideScalar, this);
      elseif matlabcoder.MatrixView.isRealMatrix(this)&&matlabcoder.MatrixView.isRealMatrix(B)
        res = matlabcoder.OperationValue.of(B, matlabcoder.MatrixOperationEnum.LeftDivideMatrix, this);
      else
        matlabcoder.Util.throwException('MatrixView:plus:IllegalArgument', 'Illegal argument.');
      end
    end
    ...
    function res = mtimes(this, B)
      coder.inline('never');
      if matlabcoder.MatrixView.isRealMatrix(this)&&matlabcoder.VectorView.isRealVector(B)
        res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.MatrixMTimesVector, B);
      elseif matlabcoder.MatrixView.isRealMatrix(this)&&matlabcoder.MatrixView.isRealMatrix(B)
        res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.MatrixMTimesMatrix, B);
      elseif matlabcoder.MatrixView.isComplexMatrix(this)&&matlabcoder.MatrixView.isComplexMatrix(B)
        res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.CMatrixMTimesMatrix, B);
      else
        matlabcoder.Util.throwException('MatrixView:plus:IllegalArgument', 'Illegal argument.');
      end
    end
    ...
    function res = lt(this, B)
      ...
      elseif  matlabcoder.MatrixView.isRealMatrix(B)&&matlabcoder.Util.isRealScalar(this)
    ...
    function res = ge(this, B)
      ...
      function res = eq(this, B)
        ...
        elseif matlabcoder.MatrixView.isComplexMatrix(this)&&matlabcoder.MatrixView.isComplexMatrix(B)
          res =   matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.CEqualToMatrix, B);
      ...
      function res = ctranspose(this)
        coder.inline('never');
        if matlabcoder.MatrixView.isRealMatrix(this)
      ...
      function res = sumval(this)
        coder.inline('never');
        if matlabcoder.MatrixView.isRealMatrix(this)
          res = visplstub.Stub_Vsip_MSumvalR(this);
        else
          res = visplstub.Stub_Vsip_MSumvalC(this);
        end
      end

      function res = euler(this)
        coder.inline('never');
        res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.Euler);
      end

      function res = conjmul(this,B)
        coder.inline('never');
        if matlabcoder.MatrixView.isComplexMatrix(this)&&matlabcoder.MatrixView.isComplexMatrix(B)
          res = matlabcoder.OperationValue.of(this, matlabcoder.MatrixOperationEnum.ConjMul);
        else
          matlabcoder.Util.throwException('MatrixView:plus:IllegalArgument', 'Illegal argument.');
        end
      end
  ...
  methods(Static)
    ...
    function res = isRealMatrix(obj)
      res = matlabcoder.MatrixView.isMatrixView(obj)&&isreal(obj.viewData());
    end

    function res = isComplexMatrix(obj)
      res = matlabcoder.MatrixView.isMatrixView(obj)&&isreal(obj.viewData());
    end
